import wx
import isolated_packages.FileDialogs as FileDialogs
import isolated_packages.biopolymer_calculator as biopolymer_calculator
import os
import numpy as np
from . import unidectools as ud
import peakwidthtools as peakwidthtools
from . import ManualSelectionWindow, AutocorrWindow, miscwindows, peakstructure, SubDiv
import time
...
class UniDecPres(object):
    ...
    def register(self, e=None):
        from .data_reader import register
        register()
